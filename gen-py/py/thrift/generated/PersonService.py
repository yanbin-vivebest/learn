...
class getPersonByUsername_args:
  """
  Attributes:
   - username
  """
...
class getPersonByUsername_result:
  """
  Attributes:
   - success
   - dateException
  ...
  thrift_spec = (
    ...
    (1, TType.STRUCT, 'dateException', (DataException, DataException.thrift_spec), None, ), # 1
  )
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.dateException)
    return value
...
class savePerson_args:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.person)
    return value
